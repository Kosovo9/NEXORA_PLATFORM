export default async function handler(req, res){
  ...
  res.status(200).send(\window.CLERK_PUBLISHABLE_KEY=\;
window.CLERK_SIGNIN_URL=\;
window.SUPABASE_URL=\;
...
window.HF_MODEL=\;\);
 ...
 // Allowed origins públicos (para detector cliente)
 if (!globalThis.__ENV_PATCHED__) {
   globalThis.__ENV_PATCHED__ = true;
 }
