...
export interface ApiImagenPrincipalImagenPrincipal
  extends Struct.CollectionTypeSchema {
  collectionName: 'imagen_principals';
  info: {
    displayName: 'imagen_principal';
    pluralName: 'imagen-principals';
    singularName: 'imagen-principal';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::imagen-principal.imagen-principal'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    galeria_multimedia: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRutinaRutina extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dificultad: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rutina.rutina'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::imagen-principal.imagen-principal': ApiImagenPrincipalImagenPrincipal;
